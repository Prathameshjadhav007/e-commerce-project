...
<title>foodbycategory</title>
    ...
    <!-- Single Page Header End -->
        ...
        <div class="container-fluid fruite py-5 " style="margin-top:30px;">
            <div class="container py-5">
                    <a href="categories" class="btn  border-dark rounded mb-3" style="width:70px"><i class="fa fa-arrow-left" aria-hidden="true" ></i></a>
                    <h1 class="mb-3">
                      ${categoryname}</h1>
                        <div class="row g-4">  
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img">
                                        <a href="productdetail?id=${p.id}">  <img src="img2/${p.productimg}" class="img-fluid w-100 rounded-top" alt=""></a>
                                    </div>
                                    ...
                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                        <div class="d-flex justify-content-between">
                                            <h5>${p.productname}</h5>
                                           <a href="savefavourite?id=${p.id}"> <i class="material-icons large" style="color:red;">favorite_border</i>
                                            </a>
                                            </div>
