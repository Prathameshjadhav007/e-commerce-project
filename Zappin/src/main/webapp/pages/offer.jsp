                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl mt-0">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="offer" class="nav-item nav-link active">Offer</a>
            ...
            <div class="container py-4">
              ...
              <c:forEach var="oc" items="${offerandcoupon}">
                <div  style="width: 23rem;">
                    <a href="#"> <img src="img2/${oc.offerimage}" class="card-img-top card-img-bottom" alt="...">  </a>        
               </div>
               </c:forEach>
               <div  style="width: 23rem;">
                <img src="img/fruite-item-2.jpg" class="card-img-top card-img-bottom" alt="...">           
          </div>
          <div  style="width: 23rem;">
            <img src="img/fruite-item-3.jpg" class="card-img-top card-img-bottom" alt="...">           
      </div>
      <div  style="width: 23rem;">
        <img src="img/fruite-item-4.jpg" class="card-img-top card-img-bottom" alt="...">           
  </div>
