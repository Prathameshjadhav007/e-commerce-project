...
<meta charset="ISO-8859-1">
 <title>Admin offer and cuppon</title>
     <!-- Favicon icon -->
                        ...
                        <div class="basic-form" >
                            <form action="saveoffer" method="post">
                                ...
                                <div class="form-group ">
                                    <label class="card-title ">Enter coupen code</label>
                                    <div >
                                        <input type="text" name="couponcode" class="form-control border-dark" placeholder="Enter coupen code">
                                    </div>
                                </div>
                               
                                <label class="card-title ">Enter Percentage</label>
                                <div class="input-group mb-2">
                                    <input type="text" name="percentage" value="%" class="form-control border-dark" placeholder="Enter Percentage">
                                    <div class="input-group-append">
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="card-title ">Enter Description</label>
                                    <div >
                                        <input type="text" name="description" class="form-control border-dark" placeholder="Enter Description">
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div >
                                        <input type="date" name="expirydate" class="form-control border-dark" placeholder="Enter Description">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="card-title">Status</label>
                                    <select id="inputState" name="status" class="form-control border-dark">
                                ...
                                <div class="form-group " >
                                    <label class="card-title">Offer image</label>
                                    <div >
                                        <input type="file" name="offerimage" class="form-control border-dark">
                                    </div>
                                </div >  
                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <div class="card-body py-1">
                            <div class="form-group"  style=" border-bottom: 1px solid rgb(161, 182, 226);"> </div>
                               <div class="">
                                <table id="example"  class="table table-bordered " style="min-width: 665px">
                                    ...
                                    <tbody class="text-dark">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="rounded">
                                                    <a href=""><img width="125" height="100" class="rounded" src="img2/${oc.offerimage}" alt=""></a>
                                                    <span>Expiry:${oc.expirydate}</span>
                                                </div>
                                            </td>
                                            <td>${oc.couponcode}</td>
                                            <td>${oc.percentage}</td>
