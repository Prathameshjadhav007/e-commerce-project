                    ...
                    <div class="card-body py-1" >
                        <div class="basic-form" >
                            <form action="savesubcategories" method="post">
                                ...
                                <div class="form-group ">
                                    <label class="card-title">Sub-Category Name</label>
                                    <div >
                                        <input type="text" name="subcategoryname" class="form-control border-dark" placeholder="Enter Sub-Category Name">
                                    </div>
                                </div>
                                <div class="form-group " >
                                    <label class="card-title">Sub-Category img</label>
                                    <div >
                                        <input type="file" name="categoryimage" class="form-control border-dark">
                                    </div>
                                </div >  
                                ...
                                <table id="example"  class="table table-bordered " style="min-width: 675px">
                                    ...
                                    <tbody class="text-dark">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="rounded">
                                                    <a href=""><img width="100" height="100" class="rounded" src="img2/${s.categoryimage}" alt=""></a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <a href="editsubcategory?id=${s.id}" class="btn btn-warning">
                                                    <i class="mdi mdi-square-edit-outline"></i>Edit</a>
                                                    
                                                <a href="deletesubcategories?id=${s.id}" class="btn btn-danger">                                                  
