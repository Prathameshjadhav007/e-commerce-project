                        ...
                        <div class="basic-form" >
                            <form action="savecategory" method="post">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div >
                                        <input type="text" name="categoryname" class="form-control border-dark" placeholder="Enter product Name">
                                    </div>
                                </div>
                                <div class="form-group" >
                                ...
                                <table id="example"  class="table table-bordered " style="min-width: 675px">
                                    ...
                                    <tbody class="text-dark">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="rounded">
                                                    <a href=""><img width="100" height="100" class="rounded" src="img2/${c.categoryimage}" alt=""></a>
                                                </div>
                                            </td>
                                            <td><b>${c.categoryname}</b></td>
                                            <td><a href="editcategory?id=${c.id}" class="btn btn-warning">
                                                <i class="mdi mdi-square-edit-outline"></i>Edit</a>
                                            </td>
                                            <td><a href="deletecategory?id=${c.id}" class="btn btn-danger">                                                  
